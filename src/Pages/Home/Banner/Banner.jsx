...
const Banner = () => {
  ...
  return (
    <div className="px-4 sm:px-6 pt-24 pb-4 mx-auto min-h-screen text-white max-w-7xl">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <button
            className="w-full sm:w-auto px-6 py-3 bg-sky-400 font-bold text-black rounded-full flex items-center justify-center hover:bg-sky-600 transition duration-300 ease-in-out"
            data-aos="fade-up"
            data-aos-delay="600"
